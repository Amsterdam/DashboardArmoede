...
armoede.waarh2_2=function() {
	...
	this.data[1] = [{ 'value': 23.3 }, { 'value': 76.7, 'label': false }]
}

armoede.waarh2_2.prototype.addText=function() {
	var self = this;
...
armoede.waarh2_2.prototype.create=function(parent) {
	var self = this;
