...
armoede.wieh2_1=function() {
	...
	this.data = [];
	this.data[0] = [
		{ 'label': 'werk', 'value': 33, 'unit': '%', 'color': '#FF0000' },
		{ 'label': 'uitkering', 'value': 33, 'unit': '%', 'color': '#888888' },
		{'label': 'pensioen',  'value': 33, 'unit': '%', 'color': '#71BDEE' }]
	this.data[1] = [
		{ 'value': 31, 'unit': '%' },
		{ 'value': 44, 'unit': '%'},
		{ 'value': 25, 'unit': '%' }
...
armoede.wieh2_1.prototype.addText=function() {
	var self = this;
...
armoede.wieh2_1.prototype.create=function(parent) {
	var self = this;
