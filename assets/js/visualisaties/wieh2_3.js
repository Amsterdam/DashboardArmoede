...
armoede.wieh2_3=function() {
	...
	this.data = [];
	this.data[0] = [
		{'label': '3 jaar of langer', 'value': 50, 'unit': '%', 'color': '#FF0000' },
		{'label': 'korter dan 3 jaar', 'value': 50, 'unit': '%', 'color': '#71BDEE' }
	];
	this.data[1] = [
		{ 'value': 61, 'unit': '%' },
		{ 'value': 39, 'unit': '%' }
...
armoede.wieh2_3.prototype.addText=function() {
	var self = this;
...
armoede.wieh2_3.prototype.create=function(parent) {
	var self = this;
