...
armoede.waarh2_4=function() {
	this.vis = new x3();
	this.pie = new x3.pie();
	this.pieText = new x3.pieText();

	this.data = [];
	this.data[0] = [{ 'value': 0, 'color': '#FF0000' }, { 'value': 100, 'color': '#888888' }]
	this.data[1] = [{ 'value': 16.6 }, { 'value': 73.4 }]
}

armoede.waarh2_4.prototype.addText=function() {
	var self = this;
...
armoede.waarh2_4.prototype.create=function(parent) {
	var self = this;
