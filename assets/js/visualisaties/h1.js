...
armoede.h1=function() {
	...
	this.data = [
		{'y': 'Modaal', 'x': 2372, 'color': '#888888'},
		{'y': '120% WSM', 'x': 1647, 'color': '#FF0000'},
		{'y': 'Wettelijk Sociaal\nMinimum', 'x': 1373, 'color': '#FF0000'}
	];
}

armoede.h1.prototype.addText=function() {
	var self = this;
	/*
	 * Additional text
	 */
...
armoede.h1.prototype.create=function(parent) {
	var self = this;
